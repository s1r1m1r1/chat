...
-- ACTION ALTER TABLE
--
ALTER TABLE "channel" DROP COLUMN "instanceId";
ALTER TABLE "channel" ADD COLUMN "environmentId" bigint;
--
-- ACTION CREATE TABLE
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('chat', '20250718152318267', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250718152318267', "timestamp" = now();
